    ...
    public partial class calendarDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", new DateTimeOffset(new DateTime(2004, 12, 7, 16, 25, 38, 341, DateTimeKind.Unspecified).AddTicks(6808), new TimeSpan(0, 0, 0, 0, 0)), "User@Test.com", false, "", "$2a$11$DV2zHCqRmEeyVy4esvhLGOMuQj2RDhNCHVMe/dhQMBzJdhot5jeoO", 0, "TestUser" },
                    { 2, "", new DateTimeOffset(new DateTime(2004, 12, 7, 16, 25, 38, 474, DateTimeKind.Unspecified).AddTicks(8893), new TimeSpan(0, 0, 0, 0, 0)), "Admin@Test.com", false, "", "$2a$11$O5ioQrDYwFEg.kdzdxJKE.zJAn/JU3TKG5OTAApXMVeburC5cLlLW", 1, "TestAdmin" }
                });
