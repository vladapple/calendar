    ...
    public partial class NAMEOFMIGRATION : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", new DateTimeOffset(new DateTime(2004, 12, 5, 1, 0, 8, 405, DateTimeKind.Unspecified).AddTicks(1138), new TimeSpan(0, 0, 0, 0, 0)), "User@Test.com", false, "", "$2a$11$XjWvQBAGI.S2P9aISZzTduSfj38OGJO5rWX1OHR87MIJo6huBy44u", 0, "TestUser" },
                    { 2, "", new DateTimeOffset(new DateTime(2004, 12, 5, 1, 0, 8, 594, DateTimeKind.Unspecified).AddTicks(9338), new TimeSpan(0, 0, 0, 0, 0)), "Admin@Test.com", false, "", "$2a$11$pNg9h7FvYntmhYfeh26u2utEWSrVGaXtOIorBDqR03ZWZ.A7N0dvK", 1, "TestAdmin" }
                });
