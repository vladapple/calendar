    ...
    public partial class CalendarDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", new DateTimeOffset(new DateTime(2004, 12, 4, 23, 22, 20, 68, DateTimeKind.Unspecified).AddTicks(7392), new TimeSpan(0, 0, 0, 0, 0)), "User@Test.com", false, "", "$2a$11$Oql5aVjy714o6e1Uo4AdX.NR75BGW4a0DQy7NWcE.pZuRuhO7Dm6K", 0, "TestUser" },
                    { 2, "", new DateTimeOffset(new DateTime(2004, 12, 4, 23, 22, 20, 198, DateTimeKind.Unspecified).AddTicks(8674), new TimeSpan(0, 0, 0, 0, 0)), "Admin@Test.com", false, "", "$2a$11$32ZHnncV6eaaVrHVt/cMveYBpfYVs0Jo6TMBncxBK1fqOyCKrkNZu", 1, "TestAdmin" }
                });
