    ...
    public partial class calendarDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", new DateTimeOffset(new DateTime(2004, 12, 7, 16, 22, 11, 996, DateTimeKind.Unspecified).AddTicks(7746), new TimeSpan(0, 0, 0, 0, 0)), "User@Test.com", false, "", "$2a$11$YoDs.Q/H19sKXK.i48JmlO5zYWCURrtV5Bv/aQq5V3KbeBM8kZ14C", 0, "TestUser" },
                    { 2, "", new DateTimeOffset(new DateTime(2004, 12, 7, 16, 22, 12, 132, DateTimeKind.Unspecified).AddTicks(961), new TimeSpan(0, 0, 0, 0, 0)), "Admin@Test.com", false, "", "$2a$11$ZBGSXXdXiubCEi8RSkjD2.74LGGBxulX69ggWpAtQeoDlJISU8oYG", 1, "TestAdmin" }
                });
